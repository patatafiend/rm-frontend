...
export function AppraisalDrawer() {
  ...
  const actionableMilestone =
    !isTerminal && activeMilestone !== null && activeMilestone !== "RESOLVED"
      ? activeMilestone
      : null;
          ...
          <section>
            ...
            {isLoading && !display ? (
              ...
              <dl className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-2 text-sm">
                ...
                <InfoRow
                  ...
                  value={
                    display.contract_sdate
                      ? new Date(display.contract_sdate).toLocaleDateString(
                          "en-PH",
                          {
                            month: "short",
                            day: "numeric",
                ...
                />
                <InfoRow label="Months Employed" value={tenure ?? undefined} />
              </dl>
            ) : null}
          </section>
          ...
          {display?.appraisal_status === "FOR_REGULARIZATION" && (
            <>
              ...
              <div className="rounded-md border border-red-200 bg-red-50 px-3 py-2.5 text-xs text-red-700">
                ...
                <p className="mt-0.5">
                  This employee has been automatically flagged for
                  regularization. No further action is available in PAM.
                </p>
              </div>
            </>
          )}
